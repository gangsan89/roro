...
<body>
	...
	<h1 align="center">Search PW</h1>
	<br>
	<br>
	<br>
	<form action="/searchPWProcess" class="contact-form" method="post">
		<table align="center">
			<tr>
				<td align="center" >
					<h5 align="center">아이디</h5><br>
					<input type="text" id="customerID" name="customerID" placeholder="ID"><br>
					<h5 align="center">이름</h5><br>
					<input type="text" id="customerName" name="customerName" placeholder="Name"><br> 
					<h5 align="center">주민등록번호 ('-'없이 번호만 입력해주세요)</h5><br>
					<input type="password" id="SSNumber" name="SSNumber" placeholder="SSNumber">
				</td>
			</tr>
			<tr>
				<td align="center" valign="top">
					<button type="submit">Search PW</button>
				</td>
			</tr>
		</table>
	</form>
