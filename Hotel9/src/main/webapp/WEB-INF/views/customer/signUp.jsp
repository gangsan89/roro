			...
			<tr>
				<td align="center">
					<div class="form-group">
						<label for="customerID"><h5 align="center">아이디</h5></label><br>
						<input type="text" id="customerID" name="customerID" placeholder="소문자와 숫자 6~15자리" required>
						<div class="check_font" id="checkID"></div>
					</div><br>
					<div class="form-group">
						<label for="customerPW"><h5 align="center">암호</h5></label><br>
						<input type="password" id="customerPW" name="customerPW" placeholder="대,소문자 영어,숫자,특수문자 !,@,#,$,%,^,&,*,(,)를 포함한 6~15자리" required>
						<div class="check_font" id="checkPW"></div>
					</div><br>
					<div class="form-group">
						<label for="customerPW2"><h5 align="center">암호 확인</h5></label><br> 
						<input type="password" id="customerPW2" name="customerPW2" placeholder="Confirm Password" required>
						<div class="check_font" id="checkPW2"></div>
					</div><br>
					<div class="form-group">
						<label for="customerName"><h5 align="center">이름</h5></label><br> 
						<input type="text" id="customerName" name="customerName" placeholder="한글 2글자~15글자" required>
						<div class="check_font" id="checkName"></div>
					</div><br>
					<div class="form-group required">
						<label for="SSNumber"><h5 align="center">주민등록번호 ('-'없이 번호만 입력해주세요)</h5></label><br> 
						<input type="password" id="SSNumber" name="SSNumber" placeholder="Social Security Number" required>
						<div class="check_font" id="checkSSNumber"></div>
					</div><br>
					<div class="form-group">
						<label for="customerPhoneNumber"><h5 align="center">휴대전화 ('-'없이 번호만 입력해주세요)</h5></label><br> 
						<input type="tel" id="customerPhoneNumber" name="customerPhoneNumber" placeholder="Phone Number" required>
