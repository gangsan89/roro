...
public class AdminController {
	...
	public String getaddbook(NewBookDTO book, @RequestParam("file") MultipartFile file) throws IllegalStateException, IOException {
		String filePath = "D:/libFile/";
		String fileName = file.getOriginalFilename();
		file.transferTo(new File(filePath+fileName));
		
		
		String path="/"+fileName; //선택한 파일 이름을 가져와서
