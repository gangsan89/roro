...
<body>
	...
	<div class="container">
		...
		<hr>
		고객명: ${ticket.userId}님 <br> 사물함 번호: ${ticket.seatNo}<br>
		상품명: ${ticket.seatType}시간권 - ${ticket.seatPrice}원<br>
		사용기간: ${ticket.seatStartTime} ~ ${ticket.seatEndTime}<br>
		결제금액: ${ticket.seatPrice}원<br> 결제일시: ${today}<br>
		<hr>
		<br />
